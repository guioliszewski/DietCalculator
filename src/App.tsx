...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md flex flex-col ml-80 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="agressiveCut">Cutting Agressivo (-800Kcal)</option>
      ...
      <div className="absolute top-50 right-10 w-full max-w-md mr-80">
        {result && (
          <div className=" flex-1 mt-6 p-4 bg-gray-50 rounded-md max-w-md">
